...
/* Private defines -----------------------------------------------------------*/
#define PWM_Enable_Pin GPIO_PIN_13
#define PWM_Enable_GPIO_Port GPIOC
#define TEMP_Pin GPIO_PIN_0
#define TEMP_GPIO_Port GPIOC
#define AMP_U_Pin GPIO_PIN_1
#define AMP_U_GPIO_Port GPIOC
#define AMP_V_Pin GPIO_PIN_2
#define AMP_V_GPIO_Port GPIOC
#define AMP_W_Pin GPIO_PIN_3
#define AMP_W_GPIO_Port GPIOC
